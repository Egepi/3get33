...
**
** Created: Sat Sep 12 22:04:15 2009
...
public:
    ...
    void setupUi(QMainWindow *MainMenu)
    {
        ...
        QObject::connect(pb_Quit, SIGNAL(clicked()), MainMenu, SLOT(close()));
        QObject::connect(pb_PlayGame, SIGNAL(clicked()), MainMenu, SLOT(food()));
